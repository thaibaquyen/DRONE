            ...
            <div class="col-lg-6 col-md-12">
                <div class="contact_message">
                    ...
                    <form id="contact-form" method="POST" action="assets/mail.php">
                        <div class="row">
                            <div class="col-lg-6">
                                <input name="name" placeholder="Họ tên *" type="text" id="contact_name" required> 
                            </div>
                            <div class="col-lg-6">
                                <input name="email" placeholder="Email *" type="email" id="contact_email" required>   
                            </div>
                            <div class="col-lg-6">
                                <input name="subject" placeholder="Tiêu đề *" type="text" id="contact_title" required> 
                            </div>
                              <div class="col-lg-6">
                                <input name="phone" placeholder="Số điện thoại *" type="text" id="contact_tel" required>   
                            </div>

                            <div class="col-12">
                                <div class="contact_textarea">
                                    <textarea placeholder="Văn bản *" name="message" id="contact_text" required class="form-control2"></textarea>   
                                </div>   
